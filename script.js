...
function validateForm() {
  ...
  if (nameInput.value === '' || nameInput.value.length < 3) {
    setInvalidInput(nameInput, 'Please enter a name with at least 3 characters');
  }
  ...
  if (emailInput.value === '') {
    ...
    setInvalidInput(emailInput, 'Please enter a valid email address (e.g. name@example.com)');
  }
  if (nameInput.validity.valid && phoneInput.validity.valid && emailInput.validity.valid) {
